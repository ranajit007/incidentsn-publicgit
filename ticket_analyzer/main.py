...
encoder_emb = model.get_layer('embedding_1')(encoder_inputs)

x, state_h, state_c = model.get_layer('lstm_1')(encoder_emb)
encoder_states = [state_h, state_c]
...
#decoder_embedding =  model.get_layer('embedding_2').output
#decoder_emb_2 = decoder_embedding(decoder_inputs)

decoder_emb_2 = model.get_layer('embedding_2')(decoder_inputs)

decoder_outputs, state_h, state_c = model.get_layer('lstm_2')(decoder_emb_2,initial_state=decoder_states_inputs)
decoder_states = [state_h, state_c]
decoder_dense_outputs = model.get_layer('dense_1')(decoder_outputs)
decoder_model = Model(
...
for seq_index in range(len(incident_data)):
    ...
    print('Input sentence:', incident_data['description'][seq_index])
